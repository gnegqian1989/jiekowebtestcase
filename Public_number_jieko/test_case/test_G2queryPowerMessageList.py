...
class MyTest(unittest.TestCase):
    ...
    def tearDown(self):
        print('end test')
        pass
class test_queryPowerMessageList(MyTest):
    '''测试接口：社区列表接口'''

    def test_queryPowerMessageList(self):
        '''测试用例1：社区列表接口'''

#        ==================get请求==================================

        self.url =(config.TestPlanUrl) +"/publics/hx/power/message/queryPowerMessageList.do?" \
