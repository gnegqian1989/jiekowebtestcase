...
class MyTest(unittest.TestCase):
    ...
    def tearDown(self):
        print('end test')
        pass
class test_addPowerPerson(MyTest):
    '''测试接口：加入社区接口'''

    def test_addPowerPerson(self):
        '''测试用例1：加入社区接口'''

#        ==================get请求==================================

        self.url =(config.TestPlanUrl) +"/publics/hx/power/person/addPowerPerson.do?" \
                                         "strAccount=13820559247&" \
                                         "token=9678d11a-33a1-4bb9-9b9d-3a93af491d1d&" \
                                         "strApp=hexi&" \
                                         "strUserGuid=9678d11a-33a1-4bb9-9b9d-3a93af491d1d&" \
