...
class MyTest(unittest.TestCase):
    ...
    def tearDown(self):
        print('end test')
        pass
class test_replyTaskmap(MyTest):
    '''测试接口：地图任务回复接口'''

    def test_replyTaskmap(self):
        '''测试用例1：地图任务回复接口'''
...
#        ==================post请求==================================
        ...
        self.url = (config.TestPlanUrl) + "/pc/task/replyTaskmap.do?"
        self.data = {
             "token":"9678d11a-33a1-4bb9-9b9d-3a93af491d1d" ,
             "strApp":"hexi",
             "strGuid":"18379872-8a49-4eb6-97d7-d0e1914ef3bd",
             "strContent":"88888888"
        }
        self.headers = {"Content-Type": "application/json"}
